...
readonly class FunctionStatement implements StatementInterface
{
    /**
     ...
     */
    public function __construct(private TokenInterface $name, private FunctionExpression $function)
    {
    }
